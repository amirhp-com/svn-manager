    ...
    private var editorPanel: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            if editing {
                ...
                HStack(spacing: 8) {
                    Spacer()
                    pillButton("Cancel", systemImage: "xmark") { editing = false }
                    pillButton("Save", systemImage: "checkmark") { save() }
                        .opacity((draft.name.isEmpty || draft.username.isEmpty) ? 0.5 : 1)
                ...
                pillButton("Edit", systemImage: "pencil") {
                    draft = p
                    editing = true
                }
            } else {
